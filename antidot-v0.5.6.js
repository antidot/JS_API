/*! Antidot javascript - V0.5.6 - 2016-02-03
 */
(function($) {
    ...
    Antidot.ACP = function(options) {
        ...
        this.domainAnalytics = options.domainAnalytics || options.domain;
        ...
        _AntidotGlobalParam["domainAnalytics"] = this.domainAnalytics;
    ...
    Antidot.trace = function(query, feed, options) {
        ...
        var urlCall = _AntidotGlobalParam.domainAnalytics + "/search?";
    ...
    Antidot.click = function(target, options) {
        ...
        var urlCall = _AntidotGlobalParam.domainAnalytics + "/click?";
        Antidot.ajaxCall(urlCall, urlParam);
    }
